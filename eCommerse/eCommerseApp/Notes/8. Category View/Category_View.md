...
5. Now when we run the application, we can see our table displaying the data as expected
  ...
  <kbd>
    <img src="https://github.com/MinenhleNkosi/ASP.NET_Core_Web_API/blob/main/eCommerse/eCommerseApp/Notes/8.%20Category%20View/Images/3.png?raw=true" height="auto" width="1000" />
  </kbd>
  <br />
...
7. The final code for the category view:
  ```cshtml
    @model List<Category>
