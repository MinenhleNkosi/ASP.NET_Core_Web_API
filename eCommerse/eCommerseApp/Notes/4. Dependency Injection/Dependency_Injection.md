...
3. First we want to acces the database:
    ...
    * Same thing we will have to do for the email.
      ...
      <kbd>
        <img src="https://github.com/MinenhleNkosi/ASP.NET_Core_Web_API/blob/main/eCommerse/eCommerseApp/Notes/4.%20Dependency%20Injection/Images/2.png?raw=true" height="auto" width="600" />
      </kbd>
...
4. The solution is to use dependency injection.
    ...
    * Then we will have the implementation inside Email and Db classes
       ...
       <kbd>
        <img src="https://github.com/MinenhleNkosi/ASP.NET_Core_Web_API/blob/main/eCommerse/eCommerseApp/Notes/4.%20Dependency%20Injection/Images/3.png?raw=true" height="auto" width="600" />
      </kbd>
    ...
    * After that all the pages wil automatically get the new implementation.
      ...
      <kbd>
        <img src="https://github.com/MinenhleNkosi/ASP.NET_Core_Web_API/blob/main/eCommerse/eCommerseApp/Notes/4.%20Dependency%20Injection/Images/5.png?raw=true" height="auto" width="600" />
      </kbd>
